...
| [`vande-perre-1653/`](vande-perre-1653/) | Johan van de Perre, Dutch ambassador in London, to Johan de Bruyne of Zeeland, October–November 1653: the ciphered Dutch words in Thurloe's intercepted translations (Birch, Thurloe State Papers vol. 1, pp. 500, 522, 576, 582; Tomokiyo's unsolved list) | **Read 14 Sept 2026.** 22-letter alphabetical substitution with three code groups, found ciphertext-only; key-shuffle permutation z = 4.2. A reasonable disposition to negotiate, the government awaiting orders with impatience, ten ships run, want of masts. Birch's English glosses agree and were not used. Eleven printer's misprints repaired explicitly; three code groups and two fragments open. No published Dutch text or key found. |
