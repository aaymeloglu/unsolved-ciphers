...
| [`starhemberg-1758/`](starhemberg-1758/) | Georg Adam Starhemberg, Paris, 23 May 1758 (manuscript collation) | **Partial, 21 Sept 2026.** Continuous proposed German and English reading with the 1752 key, including Farinelli and Wall. 1,726 manuscript digits; eleven conjectural repair sites and uncertain key readings remain explicit. Graded source and emended tokens, alignment and reproducible checks. |
