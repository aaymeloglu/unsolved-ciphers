...
**Site: [aaymeloglu.github.io/unsolved-ciphers](https://aaymeloglu.github.io/unsolved-ciphers/)** with side-by-side readings of [Ottobon 1589](https://aaymeloglu.github.io/unsolved-ciphers/ottobon-reading.html) [Forster 1644](https://aaymeloglu.github.io/unsolved-ciphers/forster-reading.html) [Ferdinand 1634/1635/1640](https://aaymeloglu.github.io/unsolved-ciphers/ferdinand-reading.html) [Vande Perre 1653](https://aaymeloglu.github.io/unsolved-ciphers/vandeperre-reading.html), [Starhemberg 1758](https://aaymeloglu.github.io/unsolved-ciphers/starhemberg-reading.html) and [Moray 1568](https://aaymeloglu.github.io/unsolved-ciphers/moray-reading.html).
...
| [`starhemberg-1758/`](starhemberg-1758/) | Georg Adam Starhemberg, Paris, 23 May 1758 (manuscript collation) | **Substantially deciphered, with a complete proposed reading, 21 Sept 2026.** German and English edition with the 1752 key, including Farinelli and Wall. 1,726 manuscript digits; eleven conjectural repair sites and uncertain key readings remain explicit. Graded source and emended tokens, alignment and reproducible checks. |
| [`ferdinand-1634/`](ferdinand-1634/) | Ferdinand, King of Hungary, → Cardinal-Infante Ferdinand, Stuttgart, 28 October 1634 (DECODE R1887) | **Substantial reading with unresolved passages, 23 Sept 2026.** Separate graphic/syllabic cipher; 474 elected groups including one clipped group. Literal output, source alternatives and every editorial change are recorded. Three gap readings remain conjectural; no complete translation or first-solve claim. |
...
| [`vande-perre-1653/`](vande-perre-1653/) | Paulus van de Perre, Dutch ambassador in London, to Johan de Bruyne of Zeeland, August–November 1653: ciphered Dutch phrases in Thurloe’s intercepted translations (Birch I, pp. 431, 500, 522–523, 576, 582) | **Alphabet recovered; two fragments open.** 20 runs, 322 groups: 304 S, 5 C, 13 I. The 22-letter substitution reads negotiations, Harrison and the Anabaptists, naval desertion and shortages; historical glosses supply five code meanings. Conditional key-shuffle z = 18.0 with boundaries fixed. Unprinted cipher letter catalogued at Bodleian A.7 p. 47; digits and use of this key unverified. [Evidence and retrieval targets](vande-perre-1653/evidence-audit/README.md). |
