...
<div class="entries">
  ...
  <div class="entry">
    ...
    <p>The Dutch ambassador’s ciphered words, left as numbers in the intercepted English translations: a reasonable disposition to negotiate, the government awaiting orders with impatience, the new Council of State “reckoned to our advantage”, ten ships run, want of masts. A 22-letter alphabetical substitution recovered from the printed digits; Birch’s English glosses agree, and they fix the two code groups. In the earliest letter: “a character to open a lockt chest, <em>ick segghe een cijffer</em>”, I mean a cipher.</p>
