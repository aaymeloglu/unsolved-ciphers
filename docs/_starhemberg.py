...
<header class="masthead">
  ...
  <p class="status">Partial decipherment · Continuous proposed reading</p>
</header>
...
<p>Further progress could come from a complete audit of the key’s alternatives and contemporary decipherments using the same key, especially evidence for the encipherer’s treatment of 99 and repeated 55. The current reconstruction does not uniquely prove its repairs.</p>
</section>
...
<p>Research and edition: Andy Aymeloglu with OpenAI Codex, 17–21 September 2026. This is a reproducible partial reading, not a claim of a first decipherment. {link('README.md', 'Edition and sources')}.</p></div></footer>'''
    ...
    (docs / 'starhemberg-reading.html').write_text(page('Chiffre aus Paris', 'Starhemberg, 23 May 1758: manuscript cipher, proposed German reading, English translation, historical key evidence and explicit uncertainties.', body))
