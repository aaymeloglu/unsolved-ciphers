...
The 1635 reconstruction has 51 mapped labels. The final comparison passage agrees with the draft at **93/95 letter positions**; the remaining signs occur in the securely readable words *civitas* and *iam*. Their exact glyph interpretation remains open. See [the final discrepancy check](FINAL-CHECK-1635.md); the original experiment is retained in the validation notes.
...
- **1635:** b/6, 7/y, i/1 and u/11-like readings, an unexplained p mark, apparent omissions/doubling, and draft/copy wording differences remain. Exact deletion/revision order in the draft is incomplete. The main contents and translation are recoverable despite these problems.
